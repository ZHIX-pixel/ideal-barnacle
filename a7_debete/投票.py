...
def generate_sql_modification_prompt(sql_query, user_question, Professional_vocabulary, user_question_type,
...
def process_sql_generation5(user_question, sql_query, Professional_vocabulary, user_question_type,
    ...
    while iteration < max_iterations:
        ...
        prompt_t2_zhipu = generate_sql_modification_prompt(sql_query, user_question, Professional_vocabulary,
        ...
        prompt_t2_deepseek = generate_sql_modification_prompt(sql_query, user_question, Professional_vocabulary,
                                                              user_question_type, class_names, similar_records,
                                                              deepseek_feedback)
